...
const qrembed = new EmbedBuilder().setTitle("Link do strony").setTimestamp();
...
module.exports = {
  ...
  run(msg, args) {
    if (!args[0].startsWith("http"))
      return msg.channel.send("Prosze podaj link poprawny");
    ...
    qr.toFile(
      ...
      function (err) {
        if (err) return msg.channel.send("Cos poszlo nie tak");
